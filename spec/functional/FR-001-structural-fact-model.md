...
- The library SHALL emit a `code_module` fact for each Rust inline or file
  module, each TypeScript namespace, and each Python module.
...
| FR-001-AC-3 | A Python fixture yields facts for its module, classes, methods and free functions | Test (TC-003) |
