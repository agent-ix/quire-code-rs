...
|---|---|---|---|
| StR-001 Single deterministic engine | US-001, FR-001, FR-006, NFR-001, NFR-002 | TC-001, TC-038, TC-054, TC-059 | ⬜ Planned |
| StR-002 Recovered traceability | US-002, US-003, FR-005, FR-008, NFR-004 | TC-026, TC-044, TC-066, TC-069 | ⬜ Planned |

### User Story Coverage

| User Story | Trace to FR | Test/Validation | Coverage Status |
|---|---|---|---|
| US-001 Index a code layer | FR-001, FR-002, FR-003, FR-006, FR-007 | TC-001..TC-019, TC-033..TC-043 | ⬜ Planned |
| US-002 Trace requirement to code and tests | FR-005 | TC-026..TC-032 | ⬜ Planned |
| US-003 Follow call relationships | FR-004, FR-008 | TC-020..TC-025, TC-044..TC-053 | ⬜ Planned |
...
- TC-032 extracts this repository's own test suite. It fails until the mention
  linker lands, and thereafter serves as the dogfooding check that the tracking
  tags this matrix claims are really present in the tests.
